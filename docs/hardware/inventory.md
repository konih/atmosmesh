...
| AtmosMesh Spot ([SP-01](../../agent-context/stories/SP-01.md)), first unit ([BOM](../../hardware/kicad/atmosmesh-spot/BOM.csv)) — **built and flashed 2026-09-05** ([SP-02](../../agent-context/stories/SP-02.md)); radar UART line still open | 1 ESP32-C3 SuperMini OLED, 1 SHT41, 1 VEML7700, HLK-LD2410S (the 3.3 V radar; a 3.3 V-only board cannot run the LD2450), 1 DS18B20 probe, 1 screw terminal, 3 female header strips + 2 socket strips | 4 SuperMinis, 1 SHT41 (of 4: Room, Room v2, Spot), 1 VEML7700, 0 LD2410S, 1 DS18B20; all 6 BME280 and all 10 1N5819 free again |
