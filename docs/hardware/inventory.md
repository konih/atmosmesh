...
| AtmosMesh Spot ([SP-01](../../agent-context/stories/SP-01.md)), first unit | 1 ESP32-C3 SuperMini OLED, 1 SHT41, 1 VEML7700, HLK-LD2410S (the 3.3 V radar; a 3.3 V-only board cannot run the LD2450), optionally 1 BME280 on the outdoor cable and 1 DS18B20 probe | 4 SuperMinis, 1 SHT41 (of 4: Room, Room v2, Spot), 1 VEML7700, 0 LD2410S, 5 BME280 |
