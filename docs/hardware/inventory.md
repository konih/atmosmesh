...
| AtmosMesh Spot ([SP-01](../../agent-context/stories/SP-01.md)), first unit = In/Out with probe ([BOM](../../hardware/kicad/atmosmesh-spot/BOM.csv)) | 1 ESP32-C3 SuperMini OLED, 1 SHT41, 1 VEML7700, HLK-LD2410S (the 3.3 V radar; a 3.3 V-only board cannot run the LD2450), 1 BME280 on the outdoor cable, 1 DS18B20 probe, 4 × 1N5819, 2 screw terminals, 3 female header strips + 2 socket strips | 4 SuperMinis, 1 SHT41 (of 4: Room, Room v2, Spot), 1 VEML7700, 0 LD2410S, 5 BME280, 1 DS18B20, 6 × 1N5819 |

Unreserved and looking for a project: 4 ESP32-C3 SuperMini OLED boards, 5 ESP32-C6 modules,
5 BME280, 1 VEML7700, 1 SHT41, 4 BMI160, 1 DS18B20 probe, 5 capacitive soil modules, SGP40 and
SGP41, 2 ADS1115, the 433 MHz pairs, the RFM12S, the second ENS160+AHT20, 4 OLEDs. Further Spot
units beyond the first take a BME280 on the `J_SHT` header instead of an SHT41.
